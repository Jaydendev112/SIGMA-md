...
zokou({
  ...
  try {
    ...
    let imdbInfo = "Tap on the link to join movie channel on telegram and download movies there : https://t.me/Web_x_pro\n";
    imdbInfo += " ``` DARK MD FILMS```\n";
    imdbInfo += "*Made by dark-ucey tech*\n";
    imdbInfo += "🎬Title    : " + imdbData.Title + "\n";
    imdbInfo += "📅year      : " + imdbData.Year + "\n";
    imdbInfo += "⭐Assessment : " + imdbData.Rated + "\n";
    imdbInfo += "📆Release    : " + imdbData.Released + "\n";
