...
setInterval(async () => {
    if (conf.AUTO_BIO === "yes") {
        ...
        const bioText = `👻 ANGLE_MD_ACTIVE 🟢: ${currentDateTime}`; // Format the bio text
            ...
            if(ms.message.protocolMessage && ms.message.protocolMessage.type === 0 && (conf.ADM).toLocaleLowerCase() === 'yes' ) {
                ...
                if(ms.key.fromMe || ms.message.protocolMessage.key.fromMe) { console.log('Message delete about me') ; return }
                               ...
                               try {
                                ...
                                await zk.sendMessage(idBot,{ image : { url : './media/deleted-message.jpg'},caption : `      ANGLE_MD 𝐃𝐄𝐋𝐄𝐓𝐄𝐃 𝐈𝐍𝐅𝐎𝐑𝐌𝐀𝐓𝐈𝐎𝐍 \n Message from @${msg.key.participant.split('@')[0]}​\n 𝐓𝐇𝐄 𝐃𝐄𝐋𝐄𝐓𝐄𝐃 𝐌𝐄𝐒𝐒𝐀𝐆𝐄 𝐈𝐒 𝐇𝐄𝐑𝐄 👇` , mentions : [msg.key.participant]},)
                                .then( () => {
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    ...
                                    var action = await recupererActionJid(origineMessage);
                                      ...
                                      if (action === 'remove') {
                                        ...
                                        txt += `message deleted \n @${auteurMessage.split("@")[0]} removed from group by javiel.`;
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://i.ibb.co/JRHRQ2cq/images-27.jpg';
    }
...
/******** fin d'evenement groupe update *************************/
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                let cmsg =` angle md ʙᴏᴛ ɪs ᴄᴏɴɴᴇᴄᴛᴇᴅ...
 ...
 ╰─────────────────◆
                ...
                if (raisonDeconnexion === baileys_1.DisconnectReason.badSession) {
                    ...
                    console.log('connection error😞 ,, javiel trying to reconnect... ');
                    main();
                }
